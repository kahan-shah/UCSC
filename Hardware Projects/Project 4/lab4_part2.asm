...
moveleft:
    #enter code here
    addi a0, a0, -1	# moves left one unit
    j newPosition 	

movedown:
    #enter code here
    addi a1, a1, 1	# moves down one unit
    j newPosition

moveright:
    #enter code here
    addi a0, a0, 1	# moves right one unit
    j newPosition

moveup:
    #enter code here
    addi a1, a1, -1	# moves up one unit
    j newPosition
...
moveDiagonalRightDown:
    #enter code here
    addi a1, a1, 1	# moves up down unit
    addi a0, a0, 1	# moves right one unit
    j newPosition
